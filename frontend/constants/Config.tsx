let rawUrl = process.env.EXPO_PUBLIC_API_URL || "https://pos-qrcode-conestone-production-90a8.up.railway.app";
...
if (process.env.NODE_ENV === "production" && rawUrl.includes("localhost")) {
  rawUrl = "https://pos-qrcode-conestone-production-90a8.up.railway.app";
}
